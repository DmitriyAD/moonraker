...
BASE_CONFIG: Dict[str, Dict[str, str]] = {
    "moonraker": {
        "origin": "https://github.com/DmitriyAD/moonraker.git",
        "requirements": "scripts/moonraker-requirements.txt",
        "venv_args": "-p python3",
        "install_script": "scripts/install-moonraker.sh",
        "host_repo": "Z-BoltUI-New/moonraker",
        "env": sys.executable,
        "path": MOONRAKER_PATH,
        "managed_services": "moonraker"
    },
    "klipper": {
        "moved_origin": "https://github.com/DmitriyAD/klipper.git",
        "origin": "https://github.com/DmitriyAD/klipper.git",
        "requirements": "scripts/klippy-requirements.txt",
        "venv_args": "-p python2",
        "install_script": "scripts/install-octopi.sh",
        "host_repo": "Z-Bolt/moonraker",
